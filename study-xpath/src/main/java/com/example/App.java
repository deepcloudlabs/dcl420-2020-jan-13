...
public class App {
	public static void main(String[] args) throws Exception {
		...
		MovieCollection movieCollection = (MovieCollection) unmarshaller.unmarshal(file);
//		movieCollection.getMovies()
//		               .forEach(System.out::println);
		Match match = $(movieCollection)
				.xpath("//movie[number(year) >= 1970 " + " and number(year) < 1980 " + " and genres/genre = 'Drama' ]");
		match.unmarshal(Movie.class).forEach(System.out::println);
	}
}
