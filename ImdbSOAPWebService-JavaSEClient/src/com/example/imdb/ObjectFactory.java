 ...
 * generated in the com.example.imdb package. 
...
public class ObjectFactory {
    ...
    private final static QName _Search_QNAME = new QName("http://www.example.com/imdb", "search");
    private final static QName _SearchResponse_QNAME = new QName("http://www.example.com/imdb", "searchResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.example.imdb
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.com/imdb", name = "search")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.com/imdb", name = "searchResponse")
